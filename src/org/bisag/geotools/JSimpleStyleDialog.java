...
public class JSimpleStyleDialog extends JDialog {
     ...
     * @param dataStore data store with the featuresList to be rendered
     *
     * @return a new Style instance or null if the user cancels the dialog
     */
    ...
    public static Style showDialog(Component parent, 
        ...
        text.setFont(dialog.getLabelFont());
    ...
    public JSimpleStyleDialog(Frame owner, SimpleFeatureType schema, Style initialStyle) {
        ...
        this.setPreferredSize(new java.awt.Dimension(420,350));
    ...
    /**
     * QueryWindow if the dialog was completed (user clicked the Apply button)
    ...
    private void setType() {
        ...
        // set the editValueFields available for labels
    ...
    /**
     * Set the fill opacity items to the given valueField
     * @param valueField opacity valueField between 0 and 1
     */
