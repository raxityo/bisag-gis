...
/**
 * Displays a list of the mapContent layers in an associated {@linkplain MapPane} and
...
public class MapLayerTable extends JPanel {
    ...
    /**
     * Constructor.
     * @param mapPane the mapContent pane this MapLayerTable will service.
     */
    ...
    /**
     * Set the mapContent pane that this MapLayerTable will service.
     *
     * @param mapPane the mapContent pane
     */
     ...
     * by the associated mapContent pane automatically as part of the event sequence
     * when a new MapLayer is added to the pane's MapContext.
     *
     * @param layer the mapContent layer
     */
    ...
    /**
     * Handle a ListDataEvent signallying a drag-reordering of the mapContent layers.
