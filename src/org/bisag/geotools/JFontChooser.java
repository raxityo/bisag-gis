...
class JFontChooser extends JDialog {
	...
	private JColorIcon fontColorIcon;
    ...
    static Font showDialog(Component owner, String title, Font labelFont) {
        ...
        chooser.setPreferredSize(new java.awt.Dimension(600,300));
    ...
    private void initComponents() {
        ...
        btn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	Color color = JColorChooser.showDialog(null, "Choose Font Color", fontColor);
            	if(color !=null)
            	{
            		fontColor = color;
            		fontColorIcon.setColor(fontColor);
            		fontColorLabel.repaint();
            	}
            }
        });
        panel.add(btn);
        ...
        fontColorIcon = new JColorIcon(16, 16, Color.BLACK);
        fontColorLabel = new JLabel(fontColorIcon);
