...
/**
* ColorLookupFunction performs a loockup to get colors for different regions.
* 
...
public class ColorLookupFunction extends FunctionExpressionImpl {
    ...
    public FunctionName NAME = new FunctionNameImpl("colorlookup",
            ...
            FunctionNameImpl.parameter(SOURCE_PARAM_NAME,SimpleFeatureSource.class),
    ...
    public Object[] visitorsArray;
    public Color[] visitorsColors;
    ...
    public Object evaluate(Object obj) {
        if (obj instanceof SimpleFeature) {
            ...
            Object key = getParameters().get(COLOUR_PARAM_INDEX).evaluate(feature);
    ...
    private Color addColor(Object key) {
        ...
        if(lookup.size() == numColours && LegendColorTable.countTable == 0 ) {
        	new LegendCreationWizard(lookup,getParameters().get(1).toString());
        	LegendColorTable.countTable++;
