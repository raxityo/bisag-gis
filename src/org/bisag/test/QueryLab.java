...
/**
 * The QueryWindow Lab is an excuse to try out Filters and Expressions on your own data with a table to
 * show the results.
 * <p>
...
public class QueryLab extends JFrame {
    ...
    public QueryLab() {
        ...
        dataMenu.add(new SafeAction("Get featuresList") {
            public void action(ActionEvent e) throws Throwable {
                filterFeatures();
            }
        });
    ...
    private void countFeatures() throws Exception {
        ...
        JOptionPane.showMessageDialog(text, "Number of selected featuresList:" + count);
    }
...
//        FeatureType schema = source.getSchema();
//        String name = schema.getGeometryDescriptor().getLocalName();
//        QueryWindow query = new QueryWindow(typeName, filter, new String[] { name });
        ...
        JOptionPane.showMessageDialog(text, "Center of selected featuresList:" + center);
    }
