...
//     Style style = createStyle(file, featureSource);
     ...
     Layer layer = new FeatureLayer(featureSource, createPolygonStyle());
     map.addLayer(layer);

     // Now display the map
     org.bisag.geotools.JMapFrame frame = new org.bisag.geotools.JMapFrame(map);
     frame.setExtendedState(JFrame.MAXIMIZED_BOTH);
     frame.enableLayerTable(true);
     frame.enableToolBar(true);
     JMenuBar menu = new  org.bisag.menubar.CustomMenuBar(org.bisag.geotools.JMapFrame.getMapPane());
 ...
 private Style createFromSLD(File sld) {
     try {
         ...
         System.out.println("Error Creating Style");
     }
     return null;
 }
 ...
 private Style createPolygonStyle() {
     ...
     Fill textFill = styleFactory.createFill(
